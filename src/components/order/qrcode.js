;(function(z) {
  var K = function(h, b, f, n) {
    ...
    G = function(h, b, f, n, c) {
      f = Math.max(1, f || 1)
      for (n = Math.min(40, n || 40); f <= n; f += 1)
        try {
    ...
    N = function(h, b, f, n, c, p, v, k) {
      ...
      m
        ? ((a = !p && !v),
          ...
          (q = !k && !q),
          (v = !k && !v),
          a ? b.moveTo(n + f, c) : b.moveTo(n, c),
          p ? (b.lineTo(h - f, c), b.arcTo(h, c, h, w, f)) : b.lineTo(h, c),
          q ? (b.lineTo(h, w - f), b.arcTo(h, w, n, w, f)) : b.lineTo(h, w),
          v ? (b.lineTo(n + f, w), b.arcTo(n, w, n, c, f)) : b.lineTo(n, w),
          a ? (b.lineTo(n, c + f), b.arcTo(n, c, h, c, f)) : b.lineTo(n, c))
        : ((x = p && q && d),
          (q = k && q && C),
          (k = k && v && z),
          p &&
    ...
    H = function(h, b) {
      ...
      var n = z(h).data('qrcode', f),
        c = n[0].getContext('2d')
      z(b.background).is('img')
        ? c.drawImage(b.background, 0, 0, b.size, b.size)
        : b.background &&
          ((c.fillStyle = b.background),
          c.fillRect(b.left, b.top, b.size, b.size))
      var p = b.mode
      if (1 === p || 2 === p) {
        var p = b.size,
        ...
        var x = k.measureText(b.label).width,
          ...
          k = q + k
        1 === b.mode
          ? f.addBlank(0, q - 0.01, p, k + 0.01)
          : f.addBlank(x - 0.01, q - 0.01, w + 0.01, k + 0.01)
        c.fillStyle = b.fontcolor
        c.font = v
        c.fillText(b.label, x * p, q * p + 0.75 * b.mSize * p)
      } else if (3 === p || 4 === p) {
        var p = b.size,
          v = b.mSize,
          ...
          E = q + v
        3 === b.mode
          ? f.addBlank(0, q - 0.01, p, E + 0.01)
          : f.addBlank(x - 0.01, q - 0.01, w + 0.01, E + 0.01)
        c.drawImage(b.image, x * p, q * p, k * p, v * p)
      }
      p = f.moduleCount
      v = b.size / p
      k = M
      L && 0 < b.radius && 0.5 >= b.radius && (k = N)
      c.beginPath()
      for (x = 0; x < p; x += 1)
        for (q = 0; q < p; q += 1)
          k(f, c, b, b.left + q * v, b.top + x * v, v, x, q)
      z(b.fill).is('img')
        ? ((c.strokeStyle = 'rgba(0,0,0,0.5)'),
          ...
          c.clip(),
          c.drawImage(b.fill, 0, 0, b.size, b.size),
          c.restore())
        : ((c.fillStyle = b.fill), c.fill())
      return n
    },
    I = function(h) {
      var b = z('<canvas/>')
    ...
    O = function(h) {
      ...
      if (F && 'image' === h.render)
        return z('<img/>').attr('src', I(h)[0].toDataURL('image/png'))
      var b
  ...
  var J = (function() {
    function h(b, f) {
      ...
      var a = (function() {
          ...
          for (var g = Array(b.length - d + f), e = 0; e < b.length - d; e += 1)
            g[e] = b[e + d]
          return g
        })(),
        d = {
          ...
          multiply: function(y) {
            for (
              var g = Array(d.getLength() + y.getLength() - 1), e = 0;
              e < d.getLength();
              e += 1
            )
              for (var a = 0; a < y.getLength(); a += 1)
                g[e + a] ^= c.gexp(c.glog(d.get(e)) + c.glog(y.get(a)))
            return h(g, 0)
          },
          mod: function(y) {
            if (0 > d.getLength() - y.getLength()) return d
            for (
              var g = c.glog(d.get(0)) - c.glog(y.get(0)),
                e = Array(d.getLength()),
                a = 0;
              a < d.getLength();
              a += 1
              ...
              e[a] = d.get(a)
            for (a = 0; a < y.getLength(); a += 1)
              e[a] ^= c.gexp(c.glog(y.get(a)) + g)
            return h(e, 0).mod(y)
          }
        }
      return d
    ...
    var b = function(b, c) {
      var a = f[c],
        ...
        B = function(A, f) {
          ...
          for (r = 8; r < y - 8; r += 1)
            null == d[r][6] && (d[r][6] = 0 == r % 2)
          for (r = 8; r < y - 8; r += 1)
            null == d[6][r] && (d[6][r] = 0 == r % 2)
          ...
          if (7 <= b) {
            ...
            for (l = 0; 18 > l; l += 1)
              (c = !A && 1 == ((r >> l) & 1)),
                (d[Math.floor(l / 3)][(l % 3) + y - 8 - 3] = c)
            for (l = 0; 18 > l; l += 1)
              (c = !A && 1 == ((r >> l) & 1)),
                (d[(l % 3) + y - 8 - 3][Math.floor(l / 3)] = c)
          }
          if (null == g) {
            r = p.getRSBlocks(b, a)
            l = v()
            for (c = 0; c < e.length; c += 1)
              (m = e[c]),
                l.put(m.getMode(), 4),
                l.put(m.getLength(), n.getLengthInBits(m.getMode(), b)),
                m.write(l)
            for (c = m = 0; c < r.length; c += 1) m += r[c].dataCount
            if (l.getLengthInBits() > 8 * m)
              throw Error(
            ...
            for (
              l.getLengthInBits() + 4 <= 8 * m && l.put(0, 4);
              0 != l.getLengthInBits() % 8;
            ...
            for (
              ...
              var w = r[t].dataCount,
                ...
                m = Math.max(m, z)
              B[t] = Array(w)
              for (var u = 0; u < B[t].length; u += 1)
                B[t][u] = 255 & l.getBuffer()[u + q]
              q += w
              u = n.getErrorCorrectPolynomial(z)
              w = h(B[t], u.getLength() - 1).mod(u)
              k[t] = Array(u.getLength() - 1)
              for (u = 0; u < k[t].length; u += 1)
                (z = u + w.getLength() - k[t].length),
                  (k[t][u] = 0 <= z ? w.get(z) : 0)
            }
            ...
            for (u = q = 0; u < c; u += 1)
              for (t = 0; t < r.length; t += 1)
                u < B[t].length && ((l[q] = B[t][u]), (q += 1))
            for (u = 0; u < m; u += 1)
              for (t = 0; t < r.length; t += 1)
                u < k[t].length && ((l[q] = k[t][u]), (q += 1))
            g = l
          }
          r = g
          l = -1
      ...
      A.createTableTag = function(d, a) {
        ...
        e +=
          ' padding: 0px; margin: ' +
          ('undefined' == typeof a ? 4 * d : a) +
          'px;'
        e += '">'
        e += '<tbody>'
        for (var g = 0; g < A.getModuleCount(); g += 1) {
          e += '<tr>'
          for (var b = 0; b < A.getModuleCount(); b += 1)
            (e += '<td style="'),
      ...
      A.createImgTag = function(e, d) {
        ...
        return D(a, a, function(d, a) {
          return g <= d && d < b && g <= a && a < b
            ? A.isDark(Math.floor((a - g) / e), Math.floor((d - g) / e))
              ? 0
              : 1
            : 1
        })
    ...
    var f = { L: 1, M: 0, Q: 3, H: 2 },
      n = (function() {
        ...
        m.getBCHTypeInfo = function(d) {
          for (var b = d << 10; 0 <= a(b) - a(1335); )
            b ^= 1335 << (a(b) - a(1335))
          return ((d << 10) | b) ^ 21522
        }
        m.getBCHTypeNumber = function(d) {
          for (var b = d << 12; 0 <= a(b) - a(7973); )
            b ^= 7973 << (a(b) - a(7973))
          return (d << 12) | b
        }
        ...
        m.getErrorCorrectPolynomial = function(d) {
          for (var a = h([1], 0), b = 0; b < d; b += 1)
            a = a.multiply(h([1, c.gexp(b)], 0))
          return a
        }
      ...
      c = (function() {
        for (var b = Array(256), c = Array(256), a = 0; 8 > a; a += 1)
          b[a] = 1 << a
        for (a = 8; 256 > a; a += 1)
          b[a] = b[a - 4] ^ b[a - 5] ^ b[a - 6] ^ b[a - 8]
      ...
      p = (function() {
        ...
        a.getRSBlocks = function(a, b) {
          ...
          for (var f = e.length / 3, h = [], k = 0; k < f; k += 1)
            for (
              var n = e[3 * k + 0], p = e[3 * k + 1], r = e[3 * k + 2], l = 0;
              l < n;
              l += 1
            )
              h.push(c(p, r))
      ...
      w = function() {
        ...
        f.writeByte = function(e) {
          ...
          c += 8
          for (a += 1; 6 <= c; )
            (d += String.fromCharCode(g((b >>> (c - 6)) & 63))), (c -= 6)
        }
        f.flush = function() {
          0 < c &&
            ((d += String.fromCharCode(g((b << (6 - c)) & 63))), (c = b = 0))
          if (0 != a % 3)
      ...
      z = function(b, c) {
        ...
        return {
          ...
          write: function(g) {
            ...
            var e
            e = 3
            for (var h = f(), k = 0; 4 > k; k += 1)
              h.add(String.fromCharCode(k))
            ...
            n.write(4, e)
            for (
              var p = 0, q = String.fromCharCode(a[p]), p = p + 1;
              p < a.length;
            ...
            e = k.toByteArray()
            g.writeByte(2)
            for (h = 0; 255 < e.length - h; )
              g.writeByte(255), g.writeBytes(e, h, 255), (h += 255)
